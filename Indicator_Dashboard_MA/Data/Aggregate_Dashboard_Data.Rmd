...
#| include: false
# Load files
all <- read_csv(here('Indicator_Dashboard', 'Data', paste('all_Dashboard_Data_2024.csv', sep = "")))
...
SST <- read_csv(here('Indicator_Dashboard', 'Data', paste('sst_dashboard-Mariana_', RptYr, '.csv', sep = ""))) 
Chl <- read_csv(here('Indicator_Dashboard','Data', paste('chl_dashboard-Mariana_', RptYr, '.csv', sep = "")))
Rain <- read_csv(here('Indicator_Dashboard','Data', paste('rain_dashboard-Mariana_', RptYr, '.csv', sep = "")))
