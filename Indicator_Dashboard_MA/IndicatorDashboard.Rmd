...
resource_files:
  ...
  - "Data/rnatearth_Marianas_coast.RData"
  - "Data/rnatearth_Marianas_land.RData"
...
land_proj <- readRDS(here('Data', 'rnatearth_Marianas_land.RData'))
coast_proj <- readRDS(here('Data', 'rnatearth_Marianas_coast.RData'))
