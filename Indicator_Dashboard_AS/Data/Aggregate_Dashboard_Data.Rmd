...
SST <- read_csv(here('Indicator_Dashboard', 'Data', paste('sst_dashboard-AS_', RptYr, '.csv', sep = ""))) 
Chl <- read_csv(here('Indicator_Dashboard','Data', paste('chl_dashboard-AS_', RptYr, '.csv', sep = "")))
Rain <- read_csv(here('Indicator_Dashboard','Data', paste('rain_dashboard-AS_', RptYr, '.csv', sep = "")))
