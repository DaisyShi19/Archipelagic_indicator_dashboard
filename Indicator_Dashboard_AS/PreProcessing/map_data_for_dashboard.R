...
#read in raster data
sst_2023 <- raster(here("Indicator_Dashboard/PreProcessing", "sst-AS-2024-mean.nc"))
sst_clim <- raster(here("Indicator_Dashboard/PreProcessing", "sst-AS-1985-2009-mean.nc"))
chl_2023 <- raster(here("Indicator_Dashboard/PreProcessing", "chl-AS-2024-mean.nc"))
chl_clim <- raster(here("Indicator_Dashboard/PreProcessing", "chl-AS-1998-2009-mean.nc"))
...
#save data
#saveRDS(land_proj, "Indicator_Dashboard/Data/rnatearth_AS_land.RData")
#saveRDS(coast_proj, "Indicator_Dashboard/Data/rnatearth_AS_coast.RData")

saveRDS(land_proj, here("Indicator_Dashboard", "Data", "rnatearth_AS_land.RData"))
saveRDS(coast_proj, here("Indicator_Dashboard", "Data", "rnatearth_AS_coast.RData"))
