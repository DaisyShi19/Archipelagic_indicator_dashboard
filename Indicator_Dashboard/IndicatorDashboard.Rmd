...
resource_files:
  ...
  - "Data/rnatearth_MH_coast.RData"
  - "Data/rnatearth_MH_land.RData"
...
output$map <- renderPlotly({
  ...
  if (input$indicator %in% include_anom_map_list){
    ...
    p <- ggplot() + 
      ...
      geom_rect(aes(xmin = 19, xmax = 26, ymin = 18.5, ymax = 22.5), color = "black", fill = NA, linewidth = 0.5) + #MHI box
      annotate("text", x = 32.5, y = 24.5, label = "Main Hawaiian Island Grid", size = 3.2, color = "black") +
